...
export function SlideshowScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: '#1A1A1A' }]}>
      ...
      <Animated.View style={[styles.slide, { backgroundColor: slide.color, opacity: fadeAnim }]}>
...
const styles = StyleSheet.create({
  ...
  counter: { color: 'rgba(255,255,255,0.4)', fontSize: 9, textAlign: 'center', paddingBottom: 4 },
});
